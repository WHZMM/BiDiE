# from train_options
# correspond to options/train_options_hybrid.py
# En-De and Ge-En
...
class TrainOptions:
	...
	def initialize(self):
		# 
		self.parser.add_argument('--rank', default=0, type=int, help='rank of current process')
		self.parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
		self.parser.add_argument('--world_size', default=2, type=int, help='how much hosts')
		...
		self.parser.add_argument('--batch_size', default=2, type=int, help='Batch size for En-De training')
		self.parser.add_argument('--test_batch_size', default=4, type=int, help='Batch size for testing and inference')
		self.parser.add_argument('--cam_batch_size', default=3, type=int, help='Num of cams of one sampled latent')
		self.parser.add_argument('--workers', default=4, type=int, help='Number of train dataloader workers')
		self.parser.add_argument('--sample_workers', default=1, type=int, help='Number of Ge-En train latent sample dataloader workers')
		...
		self.parser.add_argument('--latent_l2_lambda', default=1.0, type=float, help='Ge-En, l2 loss')
		self.parser.add_argument('--latent_std_lambda', default=1.0, type=float, help='Ge-En, latents std loss')
		...
		self.parser.add_argument('--start_iter', default=0, type=int, help='Start with ??? iteration. Effect when cheakpoint is not None.')
		self.parser.add_argument('--start_epo', default=0, type=int, help='Start with ??? epo. Effect when cheakpoint is not None.')
